...
public class rotateCompleteBackup extends AppCompatActivity implements View.OnTouchListener {
...
//                                angle = r;
        ...
        mTimeUp= MediaPlayer.create(rotateCompleteBackup.this,R.raw.timeup);
