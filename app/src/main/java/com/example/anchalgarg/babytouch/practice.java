...
public class practice extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTimeUp=MediaPlayer.create(practice.this,R.raw.timeup);
        ...
        mtada=MediaPlayer.create(practice.this,R.raw.tada);
...
//                                angle = r;
        ...
        mMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent TapIntent=new Intent(practice.this,Main2Activity.class);
